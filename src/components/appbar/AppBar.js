  ...
  return (
    ...
    <Container fluid className="p-0 d-flex flex-row flex-nowrap">
        <Navbar.Brand href="/dashboard" className="branding col-md-3 px-3 py-3 py-md-2 text-black d-flex justify-content-start">
          <svg id="logo-38" width="50" viewBox="0 0 78 32" className="me-2" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M55.5 0H77.5L58.5 32H36.5L55.5 0Z" className="ccustom" fill="#FF7A00"></path> <path d="M35.5 0H51.5L32.5 32H16.5L35.5 0Z" fill="#FF9736"></path> <path d="M19.5 0H31.5L12.5 32H0.5L19.5 0Z" fill="#FFBC7D"></path></svg>
